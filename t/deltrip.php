    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql1 = "SELECT * FROM trip WHERE tid='$tid'";
...
<body>
    ...
    <strong>Warning!</strong> tid  doesnot exits
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
     ...
     if($succ==true){
        ...
        Trip Deleted Successfully<a href="trip.php" class="alert-link">BACK</a>. Give it a click if you like.
      </div>';
    ...
    <div class="mb-3">
      ...
      <nav style="text-align: center;">
        <button type="submit" class="btn btn-light btn-outline-danger">DELETE TRIP</button>
      </nav>
    </div>
